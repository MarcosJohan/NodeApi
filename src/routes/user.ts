...
//Get user
router.get('/:id',[checkJwt, checkRole(['admin'])], UserController.get);
...
//Get all equipos   REVISAR
router.get('/equipos', [checkJwt, checkRole(['admin', 'gerente', 'analista'])], EquipoController.getAll)

//Get equipo
router.get('/equipo/:id', [checkJwt, checkRole(['admin', 'gerente', 'analista'])], EquipoController.get);
